...
class ProblemModelsTest {
    ...
    fun `diagnostic ids use stable kind-category-slug format`() {
        ...
        assertThat(ProblemIds.STRUCTURE_NAMING_CONTAINER_ANCESTRY_CHANGED.value)
            .isEqualTo("P-STRUCTURE-NAMING_CONTAINER_ANCESTRY_CHANGED")
        assertThat(ProblemIds.STRUCTURE_ITERATION_ANCESTRY_CHANGED.value)
            .isEqualTo("P-STRUCTURE-ITERATION_ANCESTRY_CHANGED")
        assertThat(ProblemIds.STRUCTURE_RENDERED_GUARD_CHANGED.value)
            .isEqualTo("P-STRUCTURE-RENDERED_GUARD_CHANGED")
